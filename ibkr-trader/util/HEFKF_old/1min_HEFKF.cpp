...
void OneMinuteHEFKF::setup_1min_noise_matrices() {
    ...
    R_base_ << OneMinHKFConfig::R_PRICE, 0, 0, 0,
    ...
    Q_base_(0, 0) = OneMinHKFConfig::Q_BASE_SCALE;        // Price process noise
    Q_base_(1, 1) = OneMinHKFConfig::Q_BASE_SCALE * 5.0;  // VELOCITY: 5x higher for responsiveness
    Q_base_(2, 2) = OneMinHKFConfig::Q_BASE_SCALE;        // Volume process noise
    Q_base_(3, 3) = OneMinHKFConfig::Q_BASE_SCALE;        // Spread process noise
