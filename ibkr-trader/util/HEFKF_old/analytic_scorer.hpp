...
public:
    ...
    // Configuration
    void set_normalization_params(double trend_scale = 0.5, 
                                 double flux_scale = 0.00005,
...
private:
    ...
    double trend_scale_ = 0.5;         // 95th percentile for trend_strength (returns-based)
    double flux_scale_ = 0.00005;      // 95th percentile for spectral_flux (returns-based, was 0.05)
