...
public:
    ...
    struct BucketBounds {
        // Updated to 10x more granular boundaries for 1-5 minute horizons
        static constexpr double UP_001_002_LOW = 0.0001;    // 0.01% (1 basis point)
        static constexpr double UP_001_002_HIGH = 0.0002;   // 0.02% (2 basis points)
        static constexpr double UP_002_005_LOW = 0.0002;    // 0.02% (2 basis points)
        static constexpr double UP_002_005_HIGH = 0.0005;   // 0.05% (5 basis points)
        static constexpr double UP_005_010_LOW = 0.0005;    // 0.05% (5 basis points)
        static constexpr double UP_005_010_HIGH = 0.0010;   // 0.10% (10 basis points)
        static constexpr double UP_010_PLUS_LOW = 0.0010;   // 0.10% (10 basis points)
        static constexpr double UP_010_PLUS_HIGH = 0.0050;  // 0.50% (50 basis points) - practical upper bound
        
        // Negative buckets (mirror image)
        static constexpr double DN_001_002_LOW = -0.0002;   // -0.02% (-2 basis points)
        static constexpr double DN_001_002_HIGH = -0.0001;  // -0.01% (-1 basis point)
        static constexpr double DN_002_005_LOW = -0.0005;   // -0.05% (-5 basis points)
        static constexpr double DN_002_005_HIGH = -0.0002;  // -0.02% (-2 basis points)
        static constexpr double DN_005_010_LOW = -0.0010;   // -0.10% (-10 basis points)
        static constexpr double DN_005_010_HIGH = -0.0005;  // -0.05% (-5 basis points)
        static constexpr double DN_010_PLUS_LOW = -0.0050;  // -0.50% (-50 basis points) - practical lower bound
        static constexpr double DN_010_PLUS_HIGH = -0.0010; // -0.10% (-10 basis points)
    };
